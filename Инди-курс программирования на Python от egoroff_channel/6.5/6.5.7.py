...
что сейчас очень популярно носить все подковы разного цвета. С прошлого года у Валеры остались четыре подковы, но,
возможно, некоторые из них имеют одинаковый цвет.
...
s1, s2, s3, s4 (1 ≤ s1, s2, s3, s4 ≤ 109) — цвета подков, имеющихся у Валеры.
